...
interface TerminalState {
  ...
  /**
   * Se asegura de que haya al menos una sesión.
   *
   * Reemplaza al viejo `openPanel`: desde el paso 26½, **si el panel se ve o no
   * lo decide `view-store`**, y lo único que era del dominio de la terminal en
   * aquella acción era esto. Mostrar un panel de terminales vacío obligaría a
   * un click más para hacer lo único que alguien quiere hacer ahí.
   */
