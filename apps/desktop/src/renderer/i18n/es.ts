...
export const es = {
  ...
  'command.debugTogglePanel': 'Mostrar u ocultar el panel de depuración',
  ...
  'command.problemsTogglePanel': 'Mostrar u ocultar el panel de problemas',
  ...
  'command.viewSelectTheme': 'Elegir el tema de colores',
  ...
  'search.wholeWord': 'ab|',
  'tabs.close': 'Cerrar',
  'theme.builtIn': 'Incorporado',
  'theme.empty': 'Ningún tema coincide',
  'theme.label': 'Elegir el tema de colores',
  'theme.placeholder': 'Escribí el nombre de un tema…',
