...
| [0022](./0022-cascaron-con-barra-de-actividades.md)            | Cascarón con barra de actividades y vistas por registro                          | ⚠️ Aceptado, supersedida en parte por [0030](./0030-barra-de-titulo-propia.md) |
...
| [0029](./0029-asistente-de-ia-en-el-main.md)                   | Asistente de IA sobre OpenRouter, con la red en el main y escrituras confirmadas | ✅ Aceptado                                                                    |
| [0030](./0030-barra-de-titulo-propia.md)                       | Barra de título propia con `frame: false`                                        | ✅ Aceptado                                                                    |
| [0031](./0031-temas-incorporados-como-datos.md)                | Los temas incorporados son datos en `packages/core`, no extensiones              | ✅ Aceptado                                                                    |
